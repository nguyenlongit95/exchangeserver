    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="admin/RoleAndPermission/addPermission" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="guard_name" class="form-control" placeholder="...">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
