    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="admin/Email/Create" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div class="box box-danger">
                                <div class="box-header">
                                    <h3 class="box-title">Create a new email drivers</h3>
                                </div>
                                <div class="box-body">
                                        <!-- Date mm/dd/yyyy -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="email" class="form-control" placeholder="youremail@abcabc.com">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="password" class="form-control" placeholder="your password of email">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
